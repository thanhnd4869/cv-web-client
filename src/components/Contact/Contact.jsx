                ...
                <div className="row d-flex">
                    <div className="col-lg-6">
                        ...
                        <form action="#" method="POST" className="st-contact-form" id="contact-form">
                            ...
                            <div className="st-form-field">
                                <textarea cols={30} rows={10} id="msg" name="msg" placeholder="Your Message" required />
                            </div>
                            <button className="st-btn st-style1 st-color1" type="submit" id="submit" name="submit">
                                Send Message
                            </button>
                        </form>
