            ...
            <div className="container" data-aos="fade-up" data-aos-duration="800" data-aos-delay="200">
                <div className="row">
                    <div className="col-lg-6">
                        <div className="st-height-b0 st-height-lg-b50" />
                        <div className="st-resume-wrap">
                            <div className="st-resume-heading">
                                <img src="/assets/images/icon/resume-icon1.png" alt="resume-icon" />
                                <h2 className="st-resume-heading-title">{educationTitle}</h2>
                            </div>
                            <div className="st-height-b50 st-height-lg-b30" />
                    ...
                    <div className="col-lg-6">
                        ...
                        <div className="st-resume-wrap">
                            <div className="st-resume-heading">
                                <img src="/assets/images/icon/resume-icon2.png" alt="resume-icon" />
