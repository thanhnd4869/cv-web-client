  ...
  <div className='contactFormWrap relative w-full'>
    <form className='grid gap-[1.875rem] md:grid-cols-2 grid-cols-1'>
      <div className='fieldBox w-full col-span-2'>
        ...
        <textarea className='border-2 border-solid border-[#a9a9a9] focus:border-[rgba(255,255,255,.5)] focus:outline-0 bg-[transparent] rounded-[10px] md:rounded-[.9375rem] lg:rounded-[1.25rem] w-full h-[8rem] md:h-[13.125rem] p-[1.125rem] text-white' />
      </div>
