...
import { SectionTitleLightCenter2 } from '../section-titles';
  ...
  <div className='contactFormWrap py-12 md:py-16 xl:pt-[5.625rem] xl:pb-[6.5625rem] px-[1.875rem] sm:px-[2.5rem] md:px-[5rem] lg:px-[9.375rem] relative w-full'>
    ...
    <form className='grid gap-[1.875rem] lg:grid-cols-2 grid-cols-1'>
      ...
      <div className='fieldBox relative w-full'>
        ...
        <textarea className='border-2 border-solid border-[#a9a9a9] block focus:border-[rgba(255,255,255,.5)] focus:outline-0 bg-[transparent] rounded-[10px] md:rounded-[.9375rem] lg:rounded-[1.25rem] w-full h-[7.5rem] md:h-[12rem] p-[1.125rem] text-white' />
        <button
