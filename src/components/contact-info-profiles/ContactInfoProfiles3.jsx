...
const ContactInfoProfiles3 = () => (
  <section className='contactInfoProfWrap mt-[5rem] md:mt-[5.5rem] lg:mt-[6.875rem] relative w-100'>
    <div
    ...
    <div className='container sm:container md:container lg:container xl:container 2xl:container mx-auto'>
      <div className='contactInfoProfList gap-[.9375rem] grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 grid-cols-1 relative w-full -top-[5rem] md:-top-[5.5rem] lg:-top-[6.875rem]'>
        {profile.map(
          (item, index) =>
            index < 3 && (
              <div className={item.bgColor} key={index}>
                <div className='profBoxInner p-5'>
                  <span className='inline-block'>{item.profIcon}</span>
                  ...
                  >
                    {item.profLinkCap} <FaAngleDoubleRight />
                  </a>
                </div>
                {/* Profile Box */}
              </div>
...
export default ContactInfoProfiles3;
