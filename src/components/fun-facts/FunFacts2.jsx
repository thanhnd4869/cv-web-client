...
import { SectionTitleSimple2 } from '../section-titles';

const FunFacts2 = () => {
  const [counterOn, setCounterOn] = useState(false);

  return (
    <section className='funFactsWrap py-[5rem] md:pt-[5.625rem] md:pb-[6.875rem] relative w-full'>
      <div className='container sm:container md:container lg:container xl:max-w-[73.125rem] mx-auto'>
        <SectionTitleSimple2
          title='I created over'
          titleInner='29,500+'
          title2='stunning & quality products'
          titleInner2='over last 5 year'
          title3='with satisfaction.'
        />
