...
const CategoriesWidget = () => (
  <div className='widgetBox relative w-full'>
    <div className='relative px-6 md:px-10 pt-10 md:pt-[3.4375rem] pb-10 md:pb-[4.375rem]'>
      ...
      <i className='bg-[#d5daf2] h-[1px] border-0 relative before:absolute before:bg-accent before:w-[3.125rem] before:h-[3px] before:z-[1] block before:mt-[-1px] mt-3 mb-8' />
            ...
            index < 7 && (
              ...
              >
                <Link
                  ...
                  target='_blank'
                >
                  <FaCaretRight className='absolute left-0 top-[2px] fill-accent' />
                  {item.cateItem}
                </Link>
              </li>
            ),
