...
import { SectionTitleLight } from '../section-titles';
                    ...
                    >
                      ...
                      >
                        <p className='text-desc2 relative text-[1rem] md:text-[1.25rem] leading-relaxed z-[1]'>
                          <LeftQuoteSignIcon className='h-[3.5rem] sm:h-[5.625rem] w-[3.5rem] sm:w-[6.875rem] text-accent2 opacity-5 -left-3 -top-5 absolute' />
                          {item.testiDesc}
                          <RightQuoteSignIcon className='h-[3.5rem] sm:h-[5.625rem] w-[3.5rem] sm:w-[6.875rem] text-accent2 opacity-5 -right-3 sm:-right-7 -bottom-2 absolute' />
                        </p>
