...
const profile = [
  ...
  {
    bgColor:
      'profBox group bg-white flex justify-center items-center text-center relative w-full before:h-2 before:absolute before:inset-x-0 before:top-0 before:bg-[#00a9f0] h-[23.125rem] before:z-[-1] hover:before:h-full z-[1]',
