...
const social3 = [
  {
    ...
    socialIcon: <FaFacebookF className='fill-accent2 group-hover:fill-white' size={16} />,
  ...
  },
  {
    ...
    socialIcon: <FaTwitter className='fill-accent2 group-hover:fill-white' size={16} />,
  ...
  },
  {
    ...
    socialIcon: <FaYoutube className='fill-accent2 group-hover:fill-white' size={16} />,
  ...
  },
  {
    ...
    socialIcon: <FaLinkedinIn className='fill-accent2 group-hover:fill-white' size={16} />,
