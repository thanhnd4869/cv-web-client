...
import { ReplyForm2 } from '../../components/reply-form';
...
const BlogDetail = () => (
  <Fragment>
    ...
    <Header2 />
    <PageTitle title='Blog Detail' hometitle='Home' homeURL='/' currentPage='Blog Detail' />
          ...
          <div className='col-span-2 grid gap-10 md:gap-20'>
            <div className='postDetail relative w-[calc(100vw-2.5rem)] md:w-full'>
              <div className='postDetailImage relative rounded-[10px] sm:rounded-[1.25rem] md:rounded-[3.125rem] overflow-hidden md:w-full'>
                <img className='w-full' src={PostImg1} alt='' />
                <SocialLinks4 />
                {/* Post Detail Image */}
              </div>
              ...
              <div className='postDetailInner flex flex-col gap-5 w-full mt-[3.4375rem]'>
                <p className='font-NunitoSans text-desc2 text-[1rem] md:text-[1.125rem] leading-normal'>
                  ...
                  involving plentiful of demolition can be a very dusty affair. The same is true as
                  we experience the emotional sensation of stress from our first instances of social
                  rejection ridicule. We quickly learn to fear and thus automatically avoid
                  potentially stressful situations of all kinds, including the most common of all
                  making mistakes.
                </p>
                <p className='font-NunitoSans text-desc2 text-[1rem] md:text-[1.125rem] leading-normal'>
                  Whether article spirits new her covered hastily sitting her. Money witty books nor
                  son add. Chicken age had evening believe but proceed pretend mrs. At missed advice
                  my it no sister. Miss told ham dull knew see she spot near can. Spirit her entire
                  her called.
                </p>
                ...
                <p className='font-NunitoSans text-desc2 text-[1rem] md:text-[1.125rem] leading-normal'>
                  ...
                  is that the text does not attract attention to itself or distract the
