...
const ErrorPage = () => (
  <Fragment>
    <Helmet>
      <title>Error Page - Fastone Personal Portfolio or CV/Resume React App</title>
    </Helmet>
    <Header2 />
    <PageTitle title='404 Error' hometitle='Home' homeURL='/' currentPage='404 Error Page' />
      ...
      <div className='container sm:container md:container lg:container xl:max-w-[73.125rem] mx-auto'>
        <div className='errorPage text-center relative flex flex-col items-center justify-center w-full'>
          <div className='errorPageInner'>
            ...
            <img className='inline-block mb-5' src={ErrorMockup} alt='Error Page' />
