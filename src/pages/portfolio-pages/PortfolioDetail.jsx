...
import { ContactInfoProfiles3 } from '../../components/contact-info-profiles';
...
import { SocialLinks4 } from '../../components/social-links';
...
const PortfolioDetail = () => {
  ...
  useEffect(() => {
    const port = portDetail.find((element) => element.id === parseInt(id, 10));
    if (port) {
      setPortfolio(port);
    }
  }, []);
        ...
        <div className='container sm:container md:container lg:container xl:max-w-[73.125rem] mx-auto'>
          <div className='portDetail relative w-full'>
            <div className='portDetailImage relative rounded-[10px] sm:rounded-[1.25rem] md:rounded-[3.125rem] overflow-hidden'>
              <img className='w-full' src={PortImg1} alt='Graphic Illustration' />
              <SocialLinks4 />
            ...
            <div className='portInfo relative z-[1] px-5 sm:px-10 md:px-[4.375rem] py-5 md:pb-10 md:pt-[3.125rem] mt-5 sm:mt-[-8.4375rem] left-0 sm:left-[7.8125rem] max-w-full sm:max-w-[35rem]'>
              ...
              <i className='bg-[#d5daf2] h-[1px] border-0 relative before:absolute before:bg-accent before:w-[3.125rem] before:h-[3px] before:z-[1] block before:mt-[-1px] mt-5 mb-4' />
              <div className='flex flex-col sm:flex-row items-start sm:items-center gap-5 sm:gap-12'>
                ...
                <div className='flex items-center gap-7'>
                  <span className='font-Poppins font-medium text-accent2 text-[.9375rem] inline-flex gap-2 items-center'>
                    <BiCommentDetail className='fill-accent' size={17} />
                    34
                  </span>
                  <span className='font-Poppins font-medium text-accent2 text-[.9375rem] inline-flex gap-2 items-center'>
                    <FiHeart className='stroke-accent' size={17} />
                    50
                  </span>
                </div>
              </div>
            ...
            <div className='portDetailInner flex flex-col gap-10 px-0 sm:px-[2.5rem] md:px-[6.25rem] pt-10 md:pt-20 w-full'>
              <div className='portDetailItem grid gap-[3.125rem] md:grid-cols-3 grid-cols-1 w-full'>
                <div className='portDetailItemInner flex flex-col gap-6 col-span-2'>
                  <p className='font-NunitoSans text-desc2 text-[1rem] md:text-[1.125rem] font-semibold leading-normal'>
                    ...
                    involving plentiful of demolition can be a very dusty affair. The same is true
                    as we experience the emotional sensation of stress from our first instances of
                    social rejection ridicule. We quickly learn to fear and thus automatically avoid
                    potentially stressful situations of all kinds of all making mistakes.
                  </p>
                  <p className='font-NunitoSans text-desc2 text-[1rem] md:text-[1.125rem] font-semibold leading-normal'>
                    Whether article spirits new her covered hastily sitting her. Money witty books
                    nor son add. Chicken age had evening believe but proceed pretend mrs. At missed
                    advice my it no sister. Miss told ham dull knew see she spot near can. Spirit
                    her entire her called. Lorem ipsum dolor sit amet, consec tetur adipiscing elit.
                    Ut elit tellus, luctus nec ullamcorper mattis, pulvinar. Lorem ipsum dolor sit
                    amet, consec tetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper
                    mattis, pulvinar.
                  </p>
                </div>
              ...
              <div className='portDetailItem grid gap-[1.875rem] md:grid-cols-2 grid-cols-1 w-full'>
                <div className='portDetailItemInner flex flex-col gap-6'>
                  ...
                  <p className='font-NunitoSans text-desc2 text-[1rem] md:text-[1.125rem] font-semibold leading-normal'>
                    The advantage of its Latin origin and the relative meaninglessness of Lorum
                    Ipsum is that the text does not attract attention to itself or distract the
                ...
                <div className='portDetailItemInner'>
                  <ul className='flex flex-col gap-5'>
                    <li className='font-NunitoSans text-desc2 text-[1rem] md:text-[1.125rem] font-semibold leading-normal flex gap-3'>
                      <CheckMark className='fill-accent h-[1rem] md:h-[1.125rem]' />
