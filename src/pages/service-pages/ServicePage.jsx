...
import { FunFacts3 } from '../../components/fun-facts';
...
const ServicePage = () => (
  <Fragment>
    ...
    <Header2 />
    <PageTitle title='My Services' hometitle='Home' homeURL='/' currentPage='My Services' />
                  ...
                  index < 6 && (
                    <div className='gridItem' key={index}>
                      <div className='serviceBox flex flex-wrap gap-3 flex-col justify-center relative w-full z-[1] min-h-[20rem] md:min-h-[24.375rem] p-[1.875rem] md:p-[3.125rem]'>
                        ...
                        />
                        <span className='inline-block mb-[.9375rem]'>{item.servIcon}</span>
                        <h3
